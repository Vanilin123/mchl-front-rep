...
import { useUpdateAdminEmployee, useUpdateEmployee } from '../../employee/form/useUpdateEmployee'


import { useDeleteAdminEmployee, useDeleteEmployee } from '../../employee/hooks/useDeleteEmployee'

export function UseEmp({ item, data }: { item: IEmployeeResponse  ,data:IProfileResponse}) {
